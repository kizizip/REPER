...
class OrderRecipeAdatper(var order: Order, var orderDetailList: MutableList<OrderDetail>, var recipeList: MutableList<Recipe>, val itemClickListener:ItemClickListener) : RecyclerView.Adapter<OrderRecipeAdatper.OrderDetailListHolder>() {
    inner class OrderDetailListHolder(private val binding: RvOrderRecipeItemBinding) : RecyclerView.ViewHolder(binding.root){
        ...
        fun bindInfo(position: Int){
            ...
            val recipeName = recipeList[position]
