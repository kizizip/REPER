...
class AllRecipeListAdapter (var recipeList:MutableList<Recipe>, val itemClickListener:ItemClickListener) : RecyclerView.Adapter<AllRecipeListAdapter.AllRecipeListHolder>() {
    inner class AllRecipeListHolder(private val binding: ItemAllRecipeRvBinding) : RecyclerView.ViewHolder(binding.root){
        fun bindInfo(position: Int){
            ...
            binding.allrecipeRvItemBtnHeart.setOnClickListener {
                itemClickListener.onClick(0, item.recipeName)
            ...
            binding.root.setOnClickListener{
                itemClickListener.onClick(1, item.recipeName)
            }
        }
    }
    ...
    fun  interface ItemClickListener {
        fun onClick(id: Int, recipeName: String)
    }
